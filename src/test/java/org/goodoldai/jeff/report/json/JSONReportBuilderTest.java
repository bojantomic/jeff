...
public class JSONReportBuilderTest extends ReportBuilderTest{
     ...
     * explanation.DataExplanationChunk, and com.google.gson.JsonObject instances that are
     * used for testing
     */
	@Before
    ...
    public void testBuildReportMainMethod() throws FileNotFoundException  {
        ...
        assertEquals(DateFormat.getInstance().format(explanation2.getCreated().getTime()), jsObject.get("date").getAsString());
    ...
    public void testInsertHeaderAllInfo() {
        ...
        assertEquals(DateFormat.getInstance().format(explanation2.getCreated().getTime()), object1.get("date").getAsString());
