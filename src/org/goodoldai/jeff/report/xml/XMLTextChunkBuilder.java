 ...
 * @author Boris Horvat
 */
public class XMLTextChunkBuilder implements ReportChunkBuilder {

    /**
     * Initializes the builder
     */
    public XMLTextChunkBuilder() {
    }

    /**
     * This method transforms a text explanation chunk into an XML report piece 
    ...
    public void buildReportChunk(ExplanationChunk echunk, Object stream) {
        ...
        insertContent(textExplenationChunk, element);
    }
     ...
     * written in as an xml document (in this case org.dom4j.Document)
     */
    private void insertContent(TextExplanationChunk textExplenationChunk, Element element) {
