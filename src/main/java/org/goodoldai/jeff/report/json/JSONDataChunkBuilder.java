...
public class JSONDataChunkBuilder implements ReportChunkBuilder{
     ...
     * dimension details and concrete data are transformed into JSON and 
     * inserted.
     *
     ...
     * TwoDimData or a ThreeDimData ), adds sub type to JSON report chunk and than calls 
     * the right method to insert the content into the document (an instance
