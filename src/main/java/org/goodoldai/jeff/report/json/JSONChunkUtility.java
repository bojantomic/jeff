...
public class JSONChunkUtility {
	 ...
	 * group, tags) into the JSON document
	 *
	 * @param echunk
	 *            explanation chunk that holds the information that needs to be
	 *            inserted
	 * @param jsonChunk
	 *            in which the content of the transformed chunk will be written
	 ...
	 *
	 * @param context
	 *            the int representation of explanation context
	 * @param echunk
	 *            explanation chunk that holds the string value of the context
	 *
	 * @return the string value of the context
	 *
	 * @throws org.goodoldai.jeff.explanation.ExplanationException
	 *             In the case of any problems by covering raised
