 ...
 * references to the concrete report chunk builder instances for the JSON report
 * type.
 *
...
public class JSONReportChunkBuilderFactory implements ReportChunkBuilderFactory {
	...
	/**
	 * An JSONDataChunkBuilder instance which is "lazy initialized" and cached
	 * for future use.
	 */
	private JSONDataChunkBuilder JSONDataChunkBuilder;
	/**
	 * An JSONImageChunkBuilder instance which is "lazy initialized" and cached
	 * for future use.
	 */
	private JSONImageChunkBuilder JSONImageChunkBuilder;
	/**
	 * An JSONTextChunkBuilder instance which is "lazy initialized" and cached
	 * for future use.
	 */
	 ...
	 *
	 * @param echunk
	 *            explanation chunk that needs to be transformed into a report
	 *            piece
	 * 
	...
	public ReportChunkBuilder getReportChunkBuilder(ExplanationChunk echunk) {
		...
		throw new ExplanationException("The provided ExplanationChunk does not match any of the required types");
	}
