...
/**
 * A concrete builder for transforming text explanation chunks into pieces of
 * JSON report
 *
...
public class JSONTextChunkBuilder implements ReportChunkBuilder {
	 ...
	 * content is, in this case, a string, it also gets inserted into the
	 * report.
	 *
	 * @param echunk
	 *            text explanation chunk that needs to be transformed
	 * @param stream
	 ...
	 *             a TextExplanationChunk instance or if the entered output
	...
	public void buildReportChunk(ExplanationChunk echunk, Object stream, boolean insertHeaders) {
		...
		jsonChunk.addProperty("type", "text");
		...
		// add chunk to explanation array
		explanation.add(jsonChunk);
	}

	/**
	 * This is a private method that is used to insert content into the JSON
	 * chunk
	 *
	 * @param textExplenationChunk
	 *            text explanation chunk which holds the content that needs to
	 *            be transformed
	 * @param object
