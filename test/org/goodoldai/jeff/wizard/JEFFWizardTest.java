 ...
 */
public class JEFFWizardTest extends TestCase {
    ...
    protected void setUp() throws IOException {
        ...
        fileUnit = new File("test" + File.separator + "units_srb_RS.properties");
        PrintWriter unitpw = new PrintWriter(new FileWriter(fileUnit));
        unitpw.println("EUR = RSD");
        unitpw.close();

        fileDimensionNames = new File("test" + File.separator + "dimension_names_srb_RS.properties");
        ...
        fileImageCaptions = new File("test" + File.separator + "image_captions_srb_RS.properties");
        ...
        fileText = new File("test" + File.separator + "text_srb_RS.properties");
        ...
        fileTextGroup = new File("test" + File.separator + "tgroup_1_text_srb_RS.properties");
        ...
        fileUnitII = new File("test" + File.separator + "units_en_US.properties");
        unitpw = new PrintWriter(new FileWriter(fileUnitII));
        unitpw.println("EUR = USD");
        unitpw.close();

        fileDimensionNamesII = new File("test" + File.separator + "dimension_names_en_US.properties");
        ...
        fileImageCaptionsII = new File("test" + File.separator + "image_captions_en_US.properties");
        ...
        fileTextII = new File("test" + File.separator + "text_en_US.properties");
        ...
        fileTextGroupII = new File("test" + File.separator + "tgroup_1_text_en_US.properties");
